...
@WebServlet("/Prive/cotationsQT")
public class CotationsQTServlet extends PrivateServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Cotation> cotationListQT = CotationManager.getInstance().listCotationQT();


        User user = UserManager.getInstance().CreateUserFromPseudo(userconnected);
        context.setVariable("useronline", user );
        context.setVariable("list", cotationListQT);
